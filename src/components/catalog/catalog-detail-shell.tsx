...
export type CatalogDetailRelatedItem = {
  entityId: string;
  href: string;
  title: string;
  description: string;
...
/** Shared framing for tool and model details; Blocks own body composition. */
export function CatalogDetailShell({
  ...
  directoryHref: '/tools' | '/models';
  hero: { eyebrow: string; title: string; description: string };
  availabilityLabel: string;
  breadcrumbHomeLabel: string;
  breadcrumbDirectoryLabel: string;
  relatedTitle: string;
  relatedItems: readonly CatalogDetailRelatedItem[];
  workbench: ReactNode;
    ...
    <article>
      ...
      >
        <nav aria-label="Breadcrumb" className="sr-only">
          ...
          <Link href={directoryHref}>{breadcrumbDirectoryLabel}</Link>
