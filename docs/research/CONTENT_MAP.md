...
The rebuilt page maps existing, reviewed UGCMind content into the reference topology. The table names semantic fields, not a runtime TypeScript module: the canonical editing source is `messages/marketing/tools/ai-image-generator/{en,zh}.json`, compiled into the pinned marketing content release before deployment.
