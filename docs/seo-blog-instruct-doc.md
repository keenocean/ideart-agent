...
与首页和工具页相同：**核心关键词密度控制在 3%–5%**，全站统一口径。这不是死线：实际判定标准是用 AITDK 插件看 2 词 / 3 词密度榜，主关键词进前 3 名即可。
...
| Best/Top 清单 | **2000–3000 词** | 每个候选品至少 150–200 词介绍；超过 3000 拆成两篇 |
| X vs Y 对比   | **1200–2500 词** | 两个对象的优缺点 + 对比表 + 结论                  |
| 问题解答      | **800–1500 词**  | 搜索意图是得到答案，简短精准比长更好              |

**底线 800 词，上限 3000 词，全站统一。** 低于 800 词 = 谷歌判定为「thin content」，几乎不可能拿到排名；超过 3000 词说明一页承载了多个主题，拆页。
...
| 6   | 字数达标                     | 800–3000 词（不同类型见前表）                   |
| 7   | 关键词密度                   | 3%–5%，2词/3词密度榜主词进前 3                  |
| 8   | 首段 100 词内有关键词        | ✅                                              |
