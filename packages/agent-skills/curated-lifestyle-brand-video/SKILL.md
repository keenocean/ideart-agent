---
name: 'curated-lifestyle-brand-video'
description: 'Encodes the creative system for a warm, elevated, hands-only lifestyle video style built on quiet confidence, wry minimalism, and the "real not styled" aesthetic. Videos open with a calm declarative hook (statement of taste, wry observation, or quiet invitation), unfold through an intimate hands-only visual grammar with amber or daylight warmth, and close with a soft spoken CTA anchored by a terracotta pill. Trigger this skill whenever producing video content in this curated-lifestyle register —'
---
...
| ----------------------- | ---------------------------------------------------------------------- | ------------------------------------------ |
| Quiet invitation        | _"There's a kind of person who never reaches for the loudest option."_ | Opens with identity, not product           |
| Wry observation         | _"I own four umbrellas. I lose one every spring."_                     | Names a universal accumulation absurdity   |
| Earned principle        | _"Fads fade. A good habit stays."_                                     | Statement of taste that earns a screenshot |
| Tender address          | _"For everyone quietly keeping it all together…"_                      | Direct address with emotional warmth       |
| Nightstand/shelf reveal | _"What's actually on my shelf this season."_                           | Demystifies curation through specificity   |
...
3. **Turn / principle** (18–35 s) — The reframe. One sentence that could live as a quote card. _"Fads fade. A good habit stays."_ Give this beat its own text overlay and a half-beat of silence before it.
...
- ✅ Use: _pleasure, intention, real, kept, chosen, enough, unhurried, well-made, attainable_
- ❌ Never use: _luxury_, _invest in yourself_, _level up_, _game-changer_, _you deserve it_, _honestly_
...
- Spoken example: _"Find it at the brand — link in bio."_
...
- Final line invites reflection, not action: _"What's the one thing you'd actually keep?"_
