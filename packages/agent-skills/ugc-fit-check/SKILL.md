---
name: 'ugc-fit-check'
description: 'Create persona- and product-constrained UGC fit-check videos with generated boards, generated clips, per-scene audio extraction, timed captions, and final composition.'
---

# UGC Fit Check

Use this for outfit try-ons, product styling checks, wearable product demos, mirror checks, routine clips, and creator fit-check ads. Require the product, wearer persona, styling constraints, allowed claims, and any identity, garment, room, brand, or voice project asset ids before generation.
